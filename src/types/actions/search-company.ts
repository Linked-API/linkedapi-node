...
export type TSearchCompanySize =
  (typeof SEARCH_COMPANY_SIZE)[keyof typeof SEARCH_COMPANY_SIZE];
...
export type TMinAnnualRevenue =
  (typeof MIN_ANNUAL_REVENUE)[keyof typeof MIN_ANNUAL_REVENUE];
...
export type TMaxAnnualRevenue =
  (typeof MAX_ANNUAL_REVENUE)[keyof typeof MAX_ANNUAL_REVENUE];
